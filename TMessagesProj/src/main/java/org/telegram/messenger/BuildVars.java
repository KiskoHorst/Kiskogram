...
public class BuildVars {
    ...
    public static int APP_ID = 10633;
    public static String APP_HASH = "e4335727e5331b3b25de2d5ceec6ed2a";

    public static String SMS_HASH = isStandaloneApp() ? "w0lkcmTZkKh" : (DEBUG_VERSION ? "O2P2z+/jBpJ" : "oLeq9AcOZkT");
    public static String PLAYSTORE_APP_URL = "https://kisko.xyz/Kiskogram/";
